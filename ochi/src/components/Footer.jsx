...
function Footer() {
  return (
    <div className=" flex gap-10 w-full h-screen bg-zinc-900 p-20 font-['Founders_Grotesk_X-Condensed']">
      ...
      <div className="w-1/2 ">
        <h1 className=" text-[9vw] font-semibold leading-none uppercase -mb-10">
          PRESENTATIONS
        </h1>
        <div className="dets font-['Neue_Montreal'] mt-10">
          {["Facebook", "Linked-in", "Instagram", "Behance"].map(
            (item, index) => (
